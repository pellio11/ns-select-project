...
0==c.max_pages&&b("#tribe-events-header").hide();a.page_title=b("#tribe-events-header").data("title");n.title=a.page_title;a.do_string&&history.pushState({tribe_params:a.params,tribe_url_params:a.url_params},a.page_title,e.cur_url+"?"+a.url_params);a.pushstate&&history.pushState({tribe_params:a.params,tribe_url_params:a.url_params},a.page_title,e.cur_url);r(b("#tribe-events-photo-events"));b(h).trigger("tribe_ev_ajaxSuccess").trigger("tribe_ev_photoView_AjaxSuccess");k&&debug.timeEnd("Photo View Ajax Timer")}})):
m.location=a.url_params.length?e.cur_url+"?"+a.url_params:e.cur_url}var d=f.get_url_param("tribe_paged"),v=f.get_url_param("tribe_event_display"),w=b("#tribe-events-photo-events"),q=0,s;a.view="photo";d&&(a.paged=d);"past"==v&&(a.view="past");r(w);g.pushstate&&!g.map_view()&&(d="action=tribe_photo&tribe_paged="+a.paged,e.params.length&&(d=d+"&"+e.params),a.category&&(d=d+"&tribe_event_category="+a.category),history.replaceState({tribe_params:d,tribe_url_params:e.params},"",location.href),b(m).on("popstate",
