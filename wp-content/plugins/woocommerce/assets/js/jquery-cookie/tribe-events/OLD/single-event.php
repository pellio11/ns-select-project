...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<p class="tribe-events-back"><a href="<?php echo tribe_get_events_link() ?>" class="btn btn-small btn-primary"> <?php _e( '&laquo; All Events', 'tribe-events-calendar' ) ?></a></p>
	...
	<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
		...
		<ul class="tribe-events-sub-nav well well-small">
